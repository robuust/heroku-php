...
# Install Apache
RUN curl --silent --location https://lang-php.s3.amazonaws.com/dist-heroku-20-develop/apache-$HTTPD_VERSION.tar.gz | tar xz -C /app/.heroku/php
# Config
...
# Install Nginx
RUN curl --silent --location https://lang-php.s3.amazonaws.com/dist-heroku-20-develop/nginx-$NGINX_VERSION.tar.gz | tar xz -C /app/.heroku/php
# Config
...
# Install PHP
RUN curl --silent --location https://lang-php.s3.amazonaws.com/dist-heroku-20-develop/php-$PHP_VERSION.tar.gz | tar xz -C /app/.heroku/php
# Config
...
RUN curl --silent --location https://lang-php.s3.amazonaws.com/dist-heroku-20-develop/extensions/no-debug-non-zts-20190902/redis-$REDIS_EXT_VERSION.tar.gz | tar xz -C /app/.heroku/php
RUN curl --silent --location https://lang-php.s3.amazonaws.com/dist-heroku-20-develop/extensions/no-debug-non-zts-20190902/imagick-$IMAGICK_EXT_VERSION.tar.gz | tar xz -C /app/.heroku/php
RUN curl --silent --location https://lang-php.s3.amazonaws.com/dist-heroku-20-develop/extensions/no-debug-non-zts-20190902/pcov-$PCOV_EXT_VERSION.tar.gz | tar xz -C /app/.heroku/php
...
# Install Composer
RUN curl --silent --location https://lang-php.s3.amazonaws.com/dist-heroku-20-develop/composer-$COMPOSER_VERSION.tar.gz | tar xz -C /app/.heroku/php
