...
ARG MEMCACHED_EXT_VERSION=3.4.0
...
RUN curl --silent --location https://lang-php.s3.us-east-1.amazonaws.com/dist-heroku-24-amd64-stable/extensions/no-debug-non-zts-20240924/memcached-$MEMCACHED_EXT_VERSION.tar.gz | tar xz -C /app/.heroku/php
...
RUN curl --silent --location https://lang-php.s3.us-east-1.amazonaws.com/dist-heroku-24-arm64-stable/extensions/no-debug-non-zts-20240924/memcached-$MEMCACHED_EXT_VERSION.tar.gz | tar xz -C /app/.heroku/php
